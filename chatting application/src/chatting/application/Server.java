...
import java.net.*;          //socket class for server in this package
import java.io.*;           //dat input stream is in this

public class Server implements ActionListener {    // JFrame comes under swing  //actionlistener interface is in awt event
    
    
    JTextField text;       // gloabally represnt so can access on other function
    JPanel a1;                 // gloabally represnt so can access on other function
    ...
    static DataOutputStream dout;
     ...
     Server() {
        ...
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("icons/1.png"));  // image iscon class used to put some image
        ...
        JLabel name = new JLabel("Yash");              // jlabel used to write anything on frame
        ...
        f.setLocation(200, 30);          // location of frame
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        right.add(p2, BorderLayout.LINE_END);          //line end to display mssg at end of line mssg we sent
        ...
        try{
            ...
            while(true) {
                ...
                while(true){
                    ...
                    JPanel left = new JPanel(new BorderLayout());                //to dispaly received mssgs
